...
class NvidiaDeepSeekCompressedPageOperations final
    : public DeepSeekCompressedPageOperations {
 public:
  static Result<NvidiaDeepSeekCompressedPageOperations> Create(
 ...
 private:
  explicit NvidiaDeepSeekCompressedPageOperations(
