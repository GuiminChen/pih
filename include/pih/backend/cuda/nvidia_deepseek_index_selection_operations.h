...
class NvidiaDeepSeekIndexSelectionOperations final
    : public DeepSeekIndexSelectionOperations {
 public:
  static Result<NvidiaDeepSeekIndexSelectionOperations> Create(
  ...
  Status validate_host_staging(
      const DeepSeekIndexSelectionHostStaging& staging) override;
 ...
 private:
  explicit NvidiaDeepSeekIndexSelectionOperations(
