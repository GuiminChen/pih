...
inline constexpr std::string_view
    kLinuxDeepSeekRankArtifactTransferControllerOperationsAbi =
        "pih_linux_deepseek_rank_artifact_transfer_controller_operations_v1";

class LinuxDeepSeekRankArtifactTransferControllerOperations final
    : public DeepSeekRankArtifactTransferOperations {
 public:
  static Result<LinuxDeepSeekRankArtifactTransferControllerOperations> Create(
  ...
  LinuxDeepSeekRankArtifactTransferControllerOperations(
      const LinuxDeepSeekRankArtifactTransferControllerOperations&) = delete;
  LinuxDeepSeekRankArtifactTransferControllerOperations& operator=(
      const LinuxDeepSeekRankArtifactTransferControllerOperations&) = delete;
  LinuxDeepSeekRankArtifactTransferControllerOperations(
      LinuxDeepSeekRankArtifactTransferControllerOperations&&) noexcept =
      default;
  LinuxDeepSeekRankArtifactTransferControllerOperations& operator=(
      LinuxDeepSeekRankArtifactTransferControllerOperations&&) noexcept =
      default;
